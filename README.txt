...
gathered in various locations. Also note that you should not move
these files to their destination until all the below instructions have
been completed.
...
(Note that we are only using the tallies value from this output)
